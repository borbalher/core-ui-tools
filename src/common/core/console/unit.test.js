describe('common/core/console/factory', () =>
{
  ...
  it('Should be able to get the util inspect options', () =>
  {
    let
  ...
  it('Should be able to get the util inspect styles', () =>
  {
    let
    console        = factory.create({
      'inspect' : {
    ...
    inspectStyles = console.getInspectStyles()

    expect(inspectStyles).to.be.deep.equal({
      'special'   : 'cyan',
      'number'    : 'blue',
      'bigint'    : 'blue',
      'boolean'   : 'blue',
  ...
  it('Should return the inspect string of an object', () =>
  {
    let
    console       = factory.create(),
    obj           = { 'foo': 'bar' },
