module.exports =
{
  core :
  {
    ...
    bootstrap :
    {
      'handlebars/helpers' : 'core/handlebars/helpers/bootstrap'
    },
    locator :
    {
      'core/handlebars'                         : __dirname,
      'core/handlebars/helpers/bootstrap'       : `${__dirname}/bootstrap`,
      ...
      'core/handlebars/helper/exists'           : `${__dirname}/helper/exists`,
