  ...
  core :
  {
    schema :
    {
      composer :
      {
        ...
        'hidden-input'         : `${__dirname}/schema/entity/hidden-input`,
        ...
        'password-input-group' : `${__dirname}/schema/entity/password-input-group`,
        'text-input-group'     : `${__dirname}/schema/entity/text-input-group`,
